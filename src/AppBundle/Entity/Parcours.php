...
class Parcours
{
     ...
     * @var integer
     *
     * @ORM\Column(name="parcours_id", type="integer")
     * @ORM\Id
     ...
     *
     * @ORM\ManyToMany(targetEntity="AppBundle\Entity\Metier1")
     * @ORM\JoinTable(name="parcours_has_metier",
     *   joinColumns={
    ...
    /**
     * @param \Doctrine\Common\Collections\Collection $metiers
     */
